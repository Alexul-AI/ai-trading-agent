...
- No bucket cap / circuit breaker / daily kill switch - this strategy is by design 2-4 diversified asset-class ETFs, not the 13-single-stock portfolio those layers were built for. Max drawdown is measured, not actively defended against mid-simulation.
